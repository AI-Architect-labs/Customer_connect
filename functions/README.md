...
Trusted server-side boundary for price validation, order writes, lifecycle transitions, notifications, rate limiting, and customer-prefill authorization.

## Stack / Tools

Firebase Cloud Functions v2, Node.js 20, TypeScript, Firebase Admin SDK.
