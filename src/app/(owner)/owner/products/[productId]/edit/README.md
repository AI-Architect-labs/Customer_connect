...
Route segment for `owner/products/[productId]/edit`. It should remain a thin composition layer and delegate behavior to `src/features/`.

## Stack / Tools

Next.js App Router, React Server/Client Component composition.
