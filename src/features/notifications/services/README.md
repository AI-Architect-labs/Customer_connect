...
Business/use-case logic for the Notifications feature. This layer validates input and coordinates repositories/functions.

## Stack / Tools

TypeScript, Zod, Firebase adapters.
