...
Cross-cutting providers for auth, loading, notifications/toasts, errors, offline state, and PWA registration.

## Stack / Tools

React Context, Firebase auth integration, PWA browser APIs.
